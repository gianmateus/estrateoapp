...
const Pagamentos = () => {
  ...
  const anosDisponiveis = useMemo(() => {
    ...
    // Não adiciona mais o ano atual automaticamente
    // Apenas adiciona anos em que existem pagamentos
    
    if (pagamentos.length === 0) {
      // Se não houver pagamentos, mostra apenas o ano atual
      anos.add(anoAtual);
    } else {
      // Adiciona anos dos pagamentos existentes
