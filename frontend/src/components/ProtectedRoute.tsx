...
interface ProtectedRouteProps {
  ...
  component?: React.ComponentType<any>;      // Component to render (optional, used instead of Outlet when provided)
}
 ...
 */
const ProtectedRoute: React.FC<ProtectedRouteProps> = ({ requiredPermission, component: Component }) => {
